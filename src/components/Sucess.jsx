...
export const Sucess = ({ SucessBox, setSucessBox, setselectOption }) => {
  const { TitleInput, DescriptionInput, TagesInput, PostContentInput } =
    useContext(ContextAPI);
  return (
    <>
      <div className={`${SucessBox ? null : "hidden"}`}>
        <div id="modal">
          <div class="fixed inset-0 p-4 flex flex-wrap justify-center items-center w-full h-full z-[1000] before:fixed before:inset-0 before:w-full before:h-full before:bg-[rgba(0,0,0,0.5)] overflow-auto">
            <div class="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
              ...
              <div class="my-10 text-center">
                ...
                <h4 class="text-xl text-slate-900 font-semibold mt-4">
              ...
              <button
                id="closeButton"
                type="button"
                class="px-5 py-2.5 w-full rounded-lg text-white text-sm font-medium border-none outline-none bg-gray-800 hover:bg-gray-700"
                onClick={() => {setselectOption("Home")}}
              >
                View Post
              </button>
            </div>
        ...
        <button
          id="openModal"
          type="button"
          class="mt-4 mx-auto block px-4 py-2 rounded-lg text-white text-sm font-medium border-none outline-none tracking-wide bg-blue-600 hover:bg-blue-700 active:bg-blue-600"
        >
          Open modal
        </button>
      </div>
